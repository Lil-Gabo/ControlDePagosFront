...
class RegisterPage {
  ...
  attachEventListeners() {
    ...
    form.addEventListener('submit', async (e) => {
      ...
      ValidationUtil.clearError(document.getElementById('nombre'));
      ValidationUtil.clearError(document.getElementById('email'));
      ValidationUtil.clearError(document.getElementById('password'));

      // Validate
      if (!ValidationUtil.isRequired(nombre)) {
        ValidationUtil.showError(document.getElementById('nombre'), 'El nombre es requerido');
        return;
      }
